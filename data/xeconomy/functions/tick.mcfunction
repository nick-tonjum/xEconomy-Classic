scoreboard players remove @a[scores={paycd=1..}] paycd 1
execute as @a[scores={paycd=1}] at @s run tellraw @s {"text":"Transaction expired.","color":"red"}
execute as @a[scores={paycd=1}] at @s run scoreboard players operation @s balance += @s paybuffer
scoreboard players enable @a xdestination
execute as @a at @s store result score @s xxpending run data get entity @s SelectedItem.tag.CustomModelData
...
execute as @e[tag=xecshop] at @s unless block ~ ~ ~ air unless block ~ ~ ~ torch unless block ~ ~ ~ redstone_torch unless block ~ ~ ~ #signs run setblock ~ ~ ~ air destroy
...
execute as @e[tag=xecadmin,tag=sellx] at @s run item replace block ^ ^ ^-1 container.10 with air
...
execute as @a[scores={pay=1..}] at @s run function xeconomy:payhandler
execute as @a[scores={xdestination=1..}] at @s unless score @s paybuffer matches 1.. run tellraw @s {"text":"You don't have an ongoing transaction!","color":"red"}
execute as @a[scores={xdestination=1..}] at @s unless score @s paybuffer matches 1.. run scoreboard players reset @s xdestination
execute as @a[scores={xdestination=1..}] at @s if score @s paybuffer matches 1.. run function xeconomy:payhandler2
...
execute as @e[tag=showbal] at @s run title @s actionbar ["",{"text":"Balance: $","bold":false,"italic":false,"color":"yellow"},{"score":{"name":"@s ","objective":"balance"},"bold":false,"italic":false,"color":"yellow"}]
...
execute as @e[tag=xecshop] at @s run item replace block ^ ^ ^-1 container.0 with lime_wool{display:{Name:"{\"text\":\"+$1\",\"color\":\"green\"}"}}
execute as @e[tag=xecshop] at @s run item replace block ^ ^ ^-1 container.1 with lime_wool{display:{Name:"{\"text\":\"+$10\",\"color\":\"green\"}"}}
execute as @e[tag=xecshop] at @s run item replace block ^ ^ ^-1 container.2 with lime_wool{display:{Name:"{\"text\":\"+$100\",\"color\":\"green\"}"}}
execute as @e[tag=xecshop] at @s run item replace block ^ ^ ^-1 container.3 with red_wool{display:{Name:"{\"text\":\"-$1\",\"color\":\"red\"}"}}
execute as @e[tag=xecshop] at @s run item replace block ^ ^ ^-1 container.4 with red_wool{display:{Name:"{\"text\":\"-$10\",\"color\":\"red\"}"}}
execute as @e[tag=xecshop] at @s run item replace block ^ ^ ^-1 container.5 with red_wool{display:{Name:"{\"text\":\"-$100\",\"color\":\"red\"}"}}
execute as @e[tag=xecshop,tag=buyx] at @s run item replace block ^ ^ ^-1 container.7 with light_blue_wool{display:{Name:"{\"text\":\"Buy Shop\",\"color\":\"aqua\"}"}}
execute as @e[tag=xecshop,tag=sellx] at @s run item replace block ^ ^ ^-1 container.7 with yellow_wool{display:{Name:"{\"text\":\"Sell Shop\",\"color\":\"yellow\"}"}}
execute as @e[tag=xecshop,scores={shopcountraw=1}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 1
execute as @e[tag=xecshop,scores={shopcountraw=2}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 2
execute as @e[tag=xecshop,scores={shopcountraw=3}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 4
execute as @e[tag=xecshop,scores={shopcountraw=4}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 8
execute as @e[tag=xecshop,scores={shopcountraw=5}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 16
execute as @e[tag=xecshop,scores={shopcountraw=6}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 32
execute as @e[tag=xecshop,scores={shopcountraw=7}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 64
execute as @e[tag=xecshop,scores={shopcountraw=8}] at @s run item replace block ^ ^ ^-1 container.6 with gray_wool{display:{Name:"{\"text\":\"Item Count\",\"color\":\"white\"}"}} 1


execute as @e[tag=xecshop] at @s run item replace block ^ ^ ^-1 container.8 with barrier{display:{Name:"{\"text\":\"Destroy Shop\",\"color\":\"red\"}"}}
